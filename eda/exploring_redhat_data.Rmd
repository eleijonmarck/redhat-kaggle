...
```{r}
type1 <- apply(merged_raw[merged_raw$activity_category == 'type 1', ], 
               MARGIN=2, FUN=function(x) length(unique(x)))

type2 <- apply(merged_raw[merged_raw$activity_category == 'type 2', ], 
               MARGIN=2, FUN=function(x) length(unique(x)))

type7 <- apply(merged_raw[merged_raw$activity_category == 'type 7', ], 
               MARGIN=2, FUN=function(x) length(unique(x)))
